const AboutContainer = () => {
    return (
      <section className="about-container">
        ...
        Prisma ORM, Next.js entre outros.</p>
        
        <p>Tenho vivência com trabalho em equipe, métodologias ágeis, integração de APIs e construção de soluções escaláveis. Estou sempre em busca de novos desafios que fortaleçam minhas habilidades técnicas e contribuam para meu
