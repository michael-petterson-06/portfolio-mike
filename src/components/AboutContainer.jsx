const AboutContainer = () => {
    return (
      <section className="about-container">
        <h2>Sobre</h2>
        <p>
            Estou em transição de carreira e a procura de oportunidades na área de
            desenvolvedor, especificamente júnior.
            Sou Desenvolvedor Full Stack com conhecimentos em HTML, CSS, JavaScript, React,
